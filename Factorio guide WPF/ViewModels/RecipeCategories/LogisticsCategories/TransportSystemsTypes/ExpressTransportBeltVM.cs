...
{
    public class ExpressTransportBeltVM: ViewModelBase
    {
        ...
        public string GetDescription
        {
            get
            {
                using (var description =
                       new StreamReader(@"..\..\..\Resources\Logistics description\Transport systems description\Express transport belt.txt"))
                    return description.ReadToEnd();
            }
        }

        public ExpressTransportBeltVM(NavigationStore navigationStore)
        {
